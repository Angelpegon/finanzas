...
<div class="capture-flow capture-flow--wide">
    ...
    <form method="POST" action="{{ route('app.tarjetas.compras.store') }}" class="dash-card form-panel" novalidate>
        @csrf
        ...
        <section class="form-section">
            ...
            <div>
                ...
                <input id="descripcion_compra" name="descripcion" value="{{ $oldCompra ? old('descripcion') : '' }}" class="form-control form-control-lg @error('descripcion', 'compra') is-invalid @enderror" placeholder="Qué compraste" required>
            ...
            <div class="row g-3">
                ...
                <div class="col-6">
                    ...
                    <select id="categoria_compra" name="categoria_id" class="form-select form-select-lg @error('categoria_id', 'compra') is-invalid @enderror" required>
            ...
            <div class="row g-3">
                ...
                <div class="col-6">
                    ...
                    <input id="interes" name="interes" type="number" min="0" step="0.01" value="{{ $oldCompra ? old('interes', 0) : 0 }}" class="form-control form-control-lg @error('interes', 'compra') is-invalid @enderror">
