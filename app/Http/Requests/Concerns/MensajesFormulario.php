...
trait MensajesFormulario
{
    ...
    public function attributes(): array
    {
        return array_merge([
            ...
            'recibido' => 'registrar cobro',
            'ejecutado' => 'registrar gasto',
            'proyectado' => 'gasto proyectado',
            'idempotency_key' => 'clave de envío',
            ...
            'tasa_compras_mensual' => 'tasa de compras',
            'tasa_avances_mensual' => 'tasa de avances',
